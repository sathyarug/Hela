...
class cost_flash_details extends Model
{
    ...
    */
    ...
    protected $fillable = ['costing_id', 'style_id', 'master_id', 'uom_id', 'conpc', 'unitprice', 'wastage', 'required_qty', 'total_required_qty', 'total_value', 'supplier_id'];
    ...
    public function getCostingLineDetails($costingId){
        ...
        return DB::table('cost_flash_details')
                 ...
                 ->where('cost_flash_details.costing_id','=',$costingId)->get();
