...
class BulkCostingDetails extends BaseValidator {
    ...
    public function getCostingItemDetails($costingId){
        ...
        return DB::table('costing_bulk_details')
                    ...
                    ->select('item_master.master_id','item_master.master_description','costing_bulk_details.article_no','org_color.color_name','costing_bulk_details.net_consumption','costing_bulk_details.unit_price','costing_bulk_details.wastage','costing_bulk_details.gross_consumption','org_supplier.supplier_name','org_size.size_name','org_uom.uom_code','org_color.color_id','org_uom.uom_id','costing_bulk_details.moq','costing_bulk_details.mcq','costing_bulk_details.calculate_by_deliverywise','costing_bulk_details.order_type','costing_bulk_details.size_id','org_supplier.supplier_id','item_category.category_code','merc_color_options.color_option','product_component.product_component_description','product_component.product_component_id')
