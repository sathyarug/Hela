                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group  col-md-4">
                                                    {{ Form::label('fname', 'First Name', array('class' => 'control-label text-semibold')) }}
                                                    {{ Form::text('fname','', array('class' => 'form-control input-xxs'))  }}
                                                </div>

                                                <div class="form-group col-md-4">
                                                    {{ Form::label('lname', 'Last Name', array('class' => 'control-label text-semibold')) }}
                                                    {{ Form::text('lname','', array('class' => 'form-control input-xxs'))  }}
                                                </div>
