            ...
            <div class="panel-body">
              ...
              <div class="tabbable">
                  <ul class="nav nav-tabs nav-tabs-highlight nav-justified">
                          <li class="active"><a href="#tab_payment_term" data-toggle="tab">Currency</a></li>
                          <li><a href="#tab_cost_center" data-toggle="tab">Malinga</a></li>
                  ...
                  <div class="tab-content">
                      <div class="tab-pane active" id="tab_payment_term">
					                      ...
					                      @include('org.currency._currency')
